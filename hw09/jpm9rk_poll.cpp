...
int main(){
  ...
  //initialization of the various histograms
...
//counters for the number of responses
  double nRoundEarth=0;
  double nFlatEarth=0;
  double nSMH=0;
  double nWhatEven=0;

  //simulating the experiment 800 times
  for(i=0;i<800;i++)
    {
      //resetting the counters each time
      nRoundEarth=0;
      nFlatEarth=0;
      nSMH=0;
      nWhatEven=0;
      //for loop for the experiment itself
       for(k=0;k<1420;k++)
	{
